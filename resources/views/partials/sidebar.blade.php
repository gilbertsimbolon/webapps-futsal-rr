...
<aside id="layout-menu"
    ...
    <ul class="menu-inner py-2 flex-grow-1 overflow-y-auto overflow-x-hidden m-0">
        ...
        @if (auth()->user()?->role === 'admin')
            ...
            <li class="menu-item {{ request()->routeIs('admin.cabang.*') ? 'active' : '' }}">
            ...
            <li class="menu-item {{ request()->routeIs('admin.lapangan.*') ? 'active' : '' }}">
            ...
            <li class="menu-item {{ request()->routeIs('admin.round-robin.monitoring') ? 'active' : '' }}">

                <a href="{{ route('admin.round-robin.monitoring') }}"
                    class="menu-link px-3">

                    <i class="menu-icon tf-icons bx bx-sync"></i>

                    <div data-i18n="Monitoring Antrean">
                        Monitoring Antrean RR
                    </div>
            ...
            <li class="menu-item {{ request()->routeIs('admin.round-robin.simulation') ? 'active' : '' }}">

                <a href="{{ route('admin.round-robin.simulation') }}"
                    class="menu-link px-3">

                    <i class="menu-icon tf-icons bx bx-calculator"></i>

                    <div data-i18n="Simulasi Antrean">
                        Simulasi Antrean RR
                    </div>
        ...
        @if (auth()->user()?->role === 'owner')
            ...
            <li class="menu-item {{ request()->routeIs('owner.metode-pembayaran.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('owner.metode-pembayaran.index') }}"
                    ...
                    <div data-i18n="Metode Pembayaran">
                        Metode Pembayaran
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const isHidden =
            localStorage.getItem('sidebar-fully-hidden') === 'true';
