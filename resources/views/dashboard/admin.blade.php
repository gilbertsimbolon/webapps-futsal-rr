                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-header bg-white border-bottom py-3">
                        <div>
                            ...
                            <p class="text-muted small mb-0">
                                Ringkasan kondisi antrean Round Robin hari ini.
                            </p>
                        </div>
                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="mb-0 fw-bold">
                                            {{ number_format($roundRobin['total']) }}
                                        </h4>
                                    </div>
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="mb-0 fw-bold">
                                            {{ number_format($roundRobin['active']) }}
                                        </h4>
                                    </div>
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="mb-0 fw-bold">
                                            {{ number_format($roundRobin['waiting']) }}
                                        </h4>
                                    </div>
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="mb-0 fw-bold">
                                            {{ number_format($roundRobin['processed']) }}
                                        </h4>
                                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span class="fw-bold">
                                        {{ $roundRobin['processed_percentage'] }}%
                                    </span>
                                ...
                                <div class="progress" style="height: 8px;">
                                    ...
                                    <div class="progress-bar" role="progressbar"
                                        style="width: {{ $roundRobin['processed_percentage'] }}%;"
                                        aria-valuenow="{{ $roundRobin['processed_percentage'] }}" aria-valuemin="0"
                                        aria-valuemax="100">
                                    </div>
                            ...
                            <div class="col-md-4 mt-3 mt-md-0">
                                ...
                                <div class="text-md-end">
                                    ...
                                    <span class="badge bg-label-{{ $roundRobin['status_type'] }} px-3 py-2">
                                        {{ $roundRobin['status'] }}
                                    </span>
